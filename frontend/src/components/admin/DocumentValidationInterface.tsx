...
const DocumentValidationInterface: React.FC<DocumentValidationInterfaceProps> = ({
    ...
    const sendValidationNotification = async () => {
        ...
        `
            ...
            await fetch(`${API_ORIGIN}/email/send`, {
                method: 'POST',
                headers: {
    ...
    const downloadDocument = async (document: Document) => {
        try {
            const response = await fetch(`${API_ORIGIN}/documents/${document.id}/download`);
                    ...
                    <Dialog open={showViewer} onOpenChange={setShowViewer}>
                        <DialogContent className="max-w-4xl max-h-[90vh]">
                            ...
                            <div className="flex-1 overflow-hidden">
                                <iframe
                                    src={`${API_ORIGIN}/documents/${selectedDocument.id}/download`}
