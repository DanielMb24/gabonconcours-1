...
const Paiement = () => {
    const {nupcan: routeNupcan} = useParams<{ nupcan: string }>();
    const numeroCandidature = decodeURIComponent(routeNupcan || '').trim().toUpperCase();
    ...
    const handlePayment = async () => {
        ...
        try {
            ...
            if (paymentStatus === 'valide') {
                ...
                toast({title: "Paiement initialisé", description: "Votre demande est en attente de confirmation par l’opérateur."});
